        ...
        while (!exit) {
            ...
            switch (option) {
                ...
                case 2 -> {
                    ...
                    /*
                    System.out.print("Ingrese la nota más alta del alumno: ");
                    alumno.setHigher_grade(scanner.nextLine());
                    System.out.print("Ingrese la edad del alumno: ");
                    alumno.setAge(scanner.nextInt());
                    System.out.print("Ingrese la calificación del alumno: ");
                    alumno.setCalificaation(scanner.nextInt());
